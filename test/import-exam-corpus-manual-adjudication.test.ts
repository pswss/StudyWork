...
describe("exact allowlisted problem manual adjudication", () => {
  it.skipIf(!existsSync(join(q31Q32LiveState, "problem.pdf")))(
    ...
    expect(PROBLEM_MANUAL_ADJUDICATION_ALLOWLIST).toHaveLength(74);
    ...
    expect(canonicalEvidenceHash(PROBLEM_MANUAL_ADJUDICATION_ALLOWLIST))
      .toBe("292c08281a6d79e875165dd149286f24baa42ee67312ef5a84e6bee1e693b763");
  ...
  it.skipIf(!existsSync(join(q43LiveState5577054, "problem.pdf")))(
    ...
    () => {
      ...
      expect({
        ...
        length: 74,
        allowlistHash: "292c08281a6d79e875165dd149286f24baa42ee67312ef5a84e6bee1e693b763",
      ...
      expect({
        ...
        rowHash: canonicalEvidenceHash(q35TerminalSpec),
        key: q35TerminalSpec.key,
        parentQuestionHash: q35TerminalSpec.parentQuestionHash,
        failedTerminalInputHash: q35TerminalSpec.failedTerminalInputHash,
        failedItemHash: q35TerminalSpec.failedItemHash,
      }).toEqual({
        length: 20,
        allowlistHash: "0c98d9f9b9a4f17eb625d248587571ae6e4c15c547941242165723f75395043c",
        rowHash: "93e085a405e16e848ba22ad8d782fecf8cdf6b628740951a0c2b3908c523e573",
        key: "13:35",
  ...
  it.skipIf(!existsSync(join(q43LiveState5577054, "problem.pdf")))(
    ...
    () => {
      ...
      expect({
        ...
        revisionLength: 18,
        revisionAllowlistHash: "1547fc78f8d5a82fa272d7baabc9b99736d56c95c2f82c6a199122e2a015935e",
  ...
  it.skipIf(!existsSync(join(q43LiveState5577054, "problem.pdf")))(
    ...
    expect({
      ...
      length: 18,
      allowlistHash: "1547fc78f8d5a82fa272d7baabc9b99736d56c95c2f82c6a199122e2a015935e",
  ...
  it.skipIf(!existsSync(join(q31Q32LiveState, "problem.pdf")))(
    ...
    expect(canonicalEvidenceHash(PROBLEM_TERMINAL_FIDELITY_ADJUDICATION_ALLOWLIST))
      .toBe("0c98d9f9b9a4f17eb625d248587571ae6e4c15c547941242165723f75395043c");
