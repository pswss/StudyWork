...
describe("exact allowlisted problem manual adjudication", () => {
  ...
  it.skipIf(!existsSync(join(q43LiveState5577054, "problem.pdf")))(
    ...
    () => {
      ...
      expect({
        ...
        length: 25,
        allowlistHash: "40adb016e691cf916a686b3bbfb537cb237fb9d7a2f45c24e91594d9d8898371",
  ...
  it.skipIf(!existsSync(join(q43LiveState5577054, "problem.pdf")))(
    ...
    () => {
      ...
      expect(PROBLEM_MANUAL_SOURCE_REVISION_ALLOWLIST).toHaveLength(14);
      expect(canonicalEvidenceHash(PROBLEM_MANUAL_SOURCE_REVISION_ALLOWLIST))
        .toBe("4f75f209838d3ba3e04751565a4086887d1f7b3c1ac915cb8f42daa9c7685089");
  ...
  it.skipIf(!existsSync(join(q31Q32LiveState, "problem.pdf")))(
    ...
    expect({
      ...
      allowlistHash: "4f75f209838d3ba3e04751565a4086887d1f7b3c1ac915cb8f42daa9c7685089",
  ...
  it.skipIf(!existsSync(join(q31Q32LiveState, "problem.pdf")))(
    ...
    expect(canonicalEvidenceHash(PROBLEM_TERMINAL_FIDELITY_ADJUDICATION_ALLOWLIST))
      .toBe("40adb016e691cf916a686b3bbfb537cb237fb9d7a2f45c24e91594d9d8898371");
